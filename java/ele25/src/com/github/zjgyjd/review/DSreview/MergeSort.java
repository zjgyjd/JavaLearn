...
public class MergeSort {
    private static void mergeSortInner(int[] array, int begin, int high, int[] extra) {
        ...
        //平均切开
        int mid = begin + (high - begin) / 2;

        mergeSortInner(array, begin, mid, extra);
        mergeSortInner(array, mid, high, extra);

        //将两个连起来
        merge(array, begin, mid, high, extra);
    }
